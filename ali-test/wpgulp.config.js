...
module.exports = {
	...
	// Scripts.
	jsVendorSRC: "assets/js/html-js/**/*.js",
	jsVendorPath: "assets/js/html-js/",
	jsSRC: [ "assets/js/html-js/**/*.js",'!assets/js/partials/', 'assets/js/partials/site-scripts.js' ],
	jsDestination: 'assets/js/html-js/',
	jsFile: 'bundle',
